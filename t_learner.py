...
class T_Learner:
    ...
    def base_model(self, x):
        ...
        output_res = get_mlp_network(input_tensor=outputs,
    ...
    def cal_loss(self):
        ...
        if self.enable_drm:
            ...
            self.loss_drm = drm(self.y_outcome, 1 - self.y_treatment,  ite_score)
            ...
            with tf.control_dependencies(update_ops):
                ...
                if mode == tf.estimator.ModeKeys.TRAIN:
                    ...
                    eval_metric_ops = {'loss_base': tf.metrics.mean(self.loss_base),
                                       'tr_auc': tf.metrics.auc(self.y_outcome, self.y_cr_pred),
                                       'cr_auc': tf.metrics.auc(self.y_outcome, self.y_tr_pred)
                                       }
